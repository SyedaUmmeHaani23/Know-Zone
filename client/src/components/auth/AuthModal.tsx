      ...
      <DialogContent className="max-w-md">
        <DialogHeader>
          <DialogTitle className="text-center">
            {view === "signin" ? "Welcome to KnowZone" : "Complete Your Profile"}
          </DialogTitle>
        </DialogHeader>
          ...
          {view === "signin" ? (
            <>
              <div className="text-center">
                ...
                <p className="text-gray-600">Join India's largest student community</p>
              </div>
            ...
            <SignupForm onComplete={() => onOpenChange(false)} />
          )}
        </div>
      </DialogContent>
    </Dialog>
